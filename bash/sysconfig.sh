...
echo "Error when printing text to stderr" >&2
}
...
function cleanup {
  rm /tmp/*.$$
  echo "All the temp files have been deleted successfully"
  exit
}
...
# Gathering data into temporary files to reduce time spent running lshw
